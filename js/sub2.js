$(function () {
    ...
    $(".s9_text1").mouseenter(function () {
        $(".s9_img1").stop().show();
    });

    $(".s9_text2>ul").click(function () {
        $(".s9_img2").stop().show();
        $(".sb9_img1").stop().hide();
    });
    $(".s9_text2>ul").mouseout(function () {
        $(".s9_img2").stop().hide();
        $(".s9_img1").stop().show();
    });

    $(".s9_text3").click(function () {
        $(".s9_img3").stop().show();
        $(".sb9_img1").stop().hide();
    });
    $(".s9_text3").mouseout(function () {
        $(".s9_img3").stop().hide();
        $(".s9_img1").stop().show();
    });

    $(".s9_text4").click(function () {
        $(".s9_img4").stop().show();
        $(".sb9_img1").stop().hide();
    });
    $(".s9_text4").mouseout(function () {
        $(".s9_img4").stop().hide();
        $(".s9_img1").stop().show();
    });
