$(function () {
    ...
    // pr3_check 디자인 요소
    const sections = document.querySelectorAll('.pr3_check');
    ...
    // pr4_symbol 디자인 요소
    const sections2 = document.querySelectorAll('.pr4_symbol');
    ...
    // pr4_symbol 디자인 요소
    const sections3 = document.querySelectorAll('.footer_top_text');
